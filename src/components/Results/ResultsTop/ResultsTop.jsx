  ...
  return (
    <div className='resultstop__wrapper'>
      <div style={{padding: "0px 30px"}}>
        <h1 style={{color: 'lightgrey'}}>{ FIRST_PAINT_HEADER }<LightBulbUI /></h1>
        <p style={{color: 'lightgrey'}}>{ FIRST_PAINT_CONTENT }</p>
        <p style={{color: 'ivory'}}>{ FIRST_PAINT_RESULT }<span style={{color: 'ivory'}}>{getDataState}</span></p>
      </div>
    </div>
  )
}
